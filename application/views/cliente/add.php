<div class="main-panel">
  ...
  <div class="content-wrapper">
    ...
    <div class="row grid-margin">
          ...
          <?php } ?>
    		  <?php echo form_open(base_url().'cliente/guardarDB',array("class"=>"forms-sample","enctype"=>"multipart/form-data")); ?>
    				        <div class="form-group row">
                    <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nombre Completo</label>
                      <div class="col-sm-4">
                        <input type="hidden" class="form-control" name="tipo_persona" value="Cliente">
